...
namespace FindGCD.Tests
{
    ...
    public class FindGCD_Binary
    {
        ...
        {
            Assert.ThrowsException<ArgumentNullException>(() => GCD.GetGcdByBinary(out Stopwatch timeSpend, null));
        }

        [TestMethod]
        public void GetGcd_minus5_5_minus55_5Returned()
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, -5, 5, -55), 5);
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 1, 0, 0, 0), 1);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 0, 1, 0, 1), 1);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => GCD.GetGcdByBinary(out Stopwatch timeSpend, int.MinValue, 0, 0));
        }

        [TestMethod]
        public void GetGcd_intMaxValue_0_0_intMaxValueReturned()
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, int.MaxValue, 0, 0), int.MaxValue);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 0, 0, 0), 0);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 0, 100, 0), 100);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 5, -7455, 1075), 5);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
        ...
        {
            Assert.AreEqual(GCD.GetGcdByBinary(out Stopwatch timeSpend, 9, 54, 99), 9);
            Assert.IsTrue(TestGetGcdFromIntegers_TimeSpend(timeSpend));
        }
