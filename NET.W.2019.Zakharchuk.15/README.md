Что можно почитать 
-	про проектирование по контракту коротко и по сути здесь (для общего развития);
-	по mock-тестированию здесь (примеры из этой статьи);
-	Искусство автономного тестирования с примерами на C#. Рой Ошероув. Главы 4-6, 
-	Видео уроки ITVDN
-	SOLID (Agile Principles, Patterns, and Practices in C#. Robert Martin, Micah Martin) или Сергей Тепляков. Паттерны проектирования на платформе .NET (Часть IV. Принципы проектирования)
